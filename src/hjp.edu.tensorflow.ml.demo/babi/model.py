...
class MemN2N(object):
    def __init__(self, batch_size, vocab_size, sentence_size, memory_size, embedding_size, 
        ...
        predict_proba_op = tf.nn._setup_softmax(logits, name = "predict_proba_op")
...
def _build_inputs(self):
    ...
    self._answers = tf.placeholder(tf.int32, [None, self_vocab_size], name = "answers")
...
def _inference(self, stories, queries):
    with tf.variable_scope(self._name):
        q_emb = tf.nn_embedding_lookup(self.A_1, queries)
